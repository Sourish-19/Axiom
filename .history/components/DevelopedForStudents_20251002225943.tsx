...
const Card: React.FC<CardProps> = ({ title, content, className = '', hasGradient = false }) => {
  return (
    <div
      className={`bg-[#181818] md:h-[360px] lg:h-[280px] xl:h-[220px] rounded-3xl group relative overflow-hidden ${className}`}
    >
      {hasGradient && (
      ...
      <div className='absolute z-2 top-0 bottom-0 left-0 right-0 p-6 flex flex-col justify-between'>
        <div className="flex justify-between items-start">
          ...
          <div className="hidden lg:hidden bg-[#FF541F] p-3 rounded-full text-white group-hover:rotate-45 transition-transform duration-300 flex-shrink-0">
    ...
    <section id="about" className="py-20 px-4">
      <div className="container max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          />
          <Card
            className="md:col-span-3 border-2 border-[#49271d]"
            title="Vision"
