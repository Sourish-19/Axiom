...
const Card: React.FC<CardProps> = ({ title, content, className = '', hasGradient = false }) => {
  return (
    <div 
      className={`relative bg-[#181818] border border-gray-800/50 p-6 rounded-3xl group relative overflow-hidden h-full flex flex-col justify-between ${className}`}
    >
      {hasGradient && (
      ...
      <div className="absolute z-10 flex justify-between items-start">
