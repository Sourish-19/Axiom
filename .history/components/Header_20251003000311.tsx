          ...
          {navLinks.map((link, idx) => {
            ...
            return (
              <a
                ...
                href={link.href}
                onClick={handleClick}
                className={`w-full text-center px-6 relative text-base text-gray-300 hover:text-white transition-colors py-2 ${idx < navLinks.length-1 ? "border-b border-white" : ""}`}
              >
                {link.name}
              </a>
            );
