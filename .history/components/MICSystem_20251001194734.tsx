                ...
                <div className="mt-20">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                        {timelineItems.map((item, index) => (
                            <div key={index} className={`relative flex flex-col items-center ${index % 2 !== 0 ? "mt-[84px]" : ""}`}>
                                ...
                                <div className={`absolute ${index%2 == 0 ? 'top-[171px] left-[253px]' : index == 1 ? 'top-[163px] left-[253px]' : 'top-[163px] left-[253px]'}`}>
