...
const EventRegistrationForm = () => {
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const subject = `New Event Registration: ${event}`;
        const mailtoBody = `
...
Selected Event: ${event}
        ...
        const mailtoLink = `mailto:sourishsrivignesh@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(mailtoBody.trim())}`;
