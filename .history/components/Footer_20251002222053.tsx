      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5 lg:col-span-6">
             <img src="/axiom_logo.png" alt="Axiom Logo" className="h-10 w-auto mb-4" />
          ...
          <div className="md:col-span-3 lg:col-span-3">
            <h4 className="text-lg font-semibold mb-4 text-[#ff541f]">Useful Links</h4>
          ...
          <div className="md:col-span-4 lg:col-span-3">
            <h4 className="text-lg font-semibold mb-4 text-[#ff541f]">Connect With Us</h4>
