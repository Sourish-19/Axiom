...
const timelineItems = [
    {
        ...
        content: (
            <div className="flex -space-x-4">
                <img className="inline-block size-12 rounded-full ring-1 ring-white object-cover" src="https://picsum.photos/seed/hack1/50" alt="Avatar 1" />
                <img className="inline-block size-12 rounded-full ring-1 ring-white object-cover" src="https://picsum.photos/seed/hack2/50" alt="Avatar 2" />
                <img className="inline-block size-12 rounded-full ring-1 ring-white object-cover" src="https://picsum.photos/seed/hack3/50" alt="Avatar 3" />
            </div>
        ),
    },
    {
    ...
    },
    {
        ...
        content: (
            <div className="flex -space-x-2">
                <img className="inline-block size-12 rounded-full ring-1 ring-white object-cover" src="https://picsum.photos/seed/prog1/50" alt="Avatar 4" />
                <img className="inline-block size-12 rounded-full ring-1 ring-white object-cover" src="https://picsum.photos/seed/prog2/50" alt="Avatar 5" />
                <img className="inline-block size-12 rounded-full ring-1 ring-white object-cover" src="https://picsum.photos/seed/prog3/50" alt="Avatar 6" />
            </div>
        ),
    },
    {
