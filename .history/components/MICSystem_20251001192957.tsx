...
const timelineItems = [
    ...
    },
    {
        ...
        content: (
            <img className="rounded-lg h-12 w-auto object-cover" src="https://picsum.photos/seed/workshop/200/80" alt="Workshop" />
        ),
    },
    {
        title: "Programs",
    ...
    },
    {
        ...
        content: (
            <img className="rounded-lg relative top-[-10px] h-12 w-auto object-cover" src="https://picsum.photos/seed/deploy/200/80" alt="Design2Deploy" />
        ),
    }
];
