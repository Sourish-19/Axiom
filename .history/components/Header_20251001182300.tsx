...
const Header: React.FC<HeaderProps> = ({ onContactClick }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-black/80 backdrop-blur-sm' : 'bg-transparent'} py-6 px-4 md:px-8 lg:px-16 xl:px-32`}>
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
            <img src="https://i.imgur.com/GHYk3vL.png" alt="Axiom Logo" className="h-8 w-auto" />
        </div>
