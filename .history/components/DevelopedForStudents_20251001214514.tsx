...
const Card: React.FC<CardProps> = ({ title, content, className = '', hasGradient = false }) => {
  return (
    ...
    >
      {hasGradient && (
        <div aria-hidden="true" className="absolute -bottom-1/2 -right-1/2 w-1/2 h-1/2 bg-[radial-gradient(circle,_rgba(255,84,31,0.2)_0%,_transparent_100%)] blur-2xl"></div>
      )}
