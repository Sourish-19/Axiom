  ...
  return (
    ...
    `}>
      <div className="p-8 flex flex-col flex-grow">
        ...
        <div className="mb-8">
          <h4 className="text-lg text-center font-semibold text-white mb-4">What's included</h4>
          <ul className="space-y-3">
            {items.map((item, index) => (
              <li key={index} className="flex items-center gap-4 text-gray-300">
                ...
                `} /> */}
                <div className="bg-[#ff541f] border border-black text-black rounded-full p-[2px] text-xs  ">
                  <FaCheck />
                </div>
