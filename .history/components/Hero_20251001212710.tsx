...
const Hero: React.FC<HeroProps> = ({ onEventClick }) => {
  return (
    <section 
      id="home" 
    ...
    >
      <div className="container mx-auto text-center relative">
        <div className="flex justify-center items-center mb-6 bg-gray-900 bg-opacity-50 border border-gray-700 rounded-full px-4 py-2 w-fit mx-auto backdrop-blur-sm">
          ...
          <div className="flex flex-co mr-3">
            <div className="flex">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <a href="#" className="border border-gray-600 text-white px-8 py-3 rounded-md font-semibold text-lg hover:bg-gray-800 transition-colors w-full sm:w-auto">
            Submit Your Micro-Project
          </a>
        </div>
      </div>
    </section>
