...
const timelineItems = [
    {
        ...
        content: (
            <div className="flex -space-x-2">
                <img className="inline-block size-12 border-2 border-white rounded-full ring-2 ring-black object-cover" src="https://picsum.photos/seed/hack1/50" alt="Avatar 1" />
