    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        emailjs
            .sendForm(
                ...
                import.meta.env.VITE_EMAILJS_TEMPLATE_ID2,  // from EmailJS template
                form,
    ...
    return (
        <div>
            ...
            <form ref={form} onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    <label htmlFor="title" className="block text-sm font-medium text-gray-300 mb-2">Select Event</label>
                    <input name="title" className="hidden" id="title" value="Event Registerion"></input>
                </div>
                <div>
                    <button
                        type="submit"
