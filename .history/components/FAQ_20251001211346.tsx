...
const AccordionItem: React.FC<AccordionItemProps> = ({ question, answer, uid, activeFAQ, setActiveFAQ }) => {
  ...
  return (
    <div className="border-b border-gray-800 py-6">
      <button onClick={() => setActiveFAQ(uid)} className="w-full flex justify-between items-center text-left text-lg font-semibold hover:text-[#FF541F] transition-colors">
        <span>{question}</span>
