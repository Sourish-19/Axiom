    ...
    >
      <div className="container mx-auto text-center relative">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <button href="#" className="border border-gray-600 text-white px-8 py-3 rounded-md font-semibold text-lg hover:bg-gray-800 transition-colors w-full sm:w-auto">
            Get In Touch
          </button>
        </div>
      </div>
