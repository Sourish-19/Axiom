                ...
                <div className="mt-20">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                        {timelineItems.map((item, index) => (
                            <div key={index} className={`relative h-[300px] flex flex-col items-center ${index % 2 !== 0 ? "xl:mt-[84px]" : ""}`}>
                                ...
                                <div className="absolute z-10 min-h-[64px] flex items-center mt-6 justify-center top-[116px] left-[-8px]">
                                    {item.content}
                                </div>
