...
const Header: React.FC<HeaderProps> = ({ onContactClick }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-black/80 backdrop-blur-md py-6 px-6 md:px-8 lg:px-16 xl:px-32`}>
      ...
      {showNavlinks && (
        <div
          className="lg:hidden absolute z-1 bg-black/80 backdrop-blur-lg h-[400px] left-0 top-[88px] right-0"
        ></div>
      )}
    </header>
  );
