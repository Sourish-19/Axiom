...
const timelineItems = [
    {
        ...
        content: (
            <div className="flex -space-x-4">
                <img className="inline-block size-12 rounded-full object-cover" src="https://picsum.photos/seed/hack1/50" alt="Avatar 1" />
                <img className="inline-block size-12 rounded-full object-cover" src="https://picsum.photos/seed/hack2/50" alt="Avatar 2" />
                <img className="inline-block size-12 rounded-full ring-2 ring-white object-cover" src="https://picsum.photos/seed/hack3/50" alt="Avatar 3" />
            </div>
        ),
    },
    {
        ...
        content: (
            <img className="rounded-lg relative top-[-8px] h-12 w-auto object-cover" src="https://picsum.photos/seed/workshop/200/80" alt="Workshop" />
        ),
    },
    {
        title: "Programs",
        ...
        content: (
            <div className="flex -space-x-2">
                <img className="inline-block size-12 rounded-full object-cover" src="https://picsum.photos/seed/prog1/50" alt="Avatar 4" />
                <img className="inline-block size-12 rounded-full object-cover" src="https://picsum.photos/seed/prog2/50" alt="Avatar 5" />
                <img className="inline-block size-12 rounded-full ring-2 ring-white object-cover" src="https://picsum.photos/seed/prog3/50" alt="Avatar 6" />
            </div>
        ),
    },
    {
        ...
        content: (
            <img className="rounded-lg relative top-[-8px] h-12 w-auto object-cover" src="https://picsum.photos/seed/deploy/200/80" alt="Design2Deploy" />
        ),
    }
];
            ...
            <div className="container max-w-[1280px] mx-auto text-center">
                ...
                <div className="mt-20">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                        {timelineItems.map((item, index) => (
                            <div key={index} className={`relative h-[160px] flex flex-col items-center ${index % 2 !== 0 ? "xl:mt-[84px]" : ""}`}>
                                <div className="text-left">
                                    <h3 className={`${item.isLargeTitle ? 'text-[#FF541F]' : ''} tracking-[-4px] text-[36px] xl:text-[46px] font-semibold`}>
                                        {item.title}
                                    </h3>
                                ...
                                <div className="absolute z-10 min-h-[64px] flex items-center xl:mt-6 justify-center bottom-[-100px] xl:bottom-none xl:top-[116px] left-[-8px]">
                                    {item.content}
                                </div>
                                ...
                                <div className={`hidden xl:block absolute ${index % 2 == 0 ? 'top-[171px] left-[253px]' : 'top-[163px] left-[253px]'}`}>
                ...
                <div className="mt-36 flex flex-col sm:flex-row justify-center items-center gap-6">
                    ...
                    <div className="flex items-center gap-3">
                        <span className="text-gray-400 text-xl">Slots are available</span>
